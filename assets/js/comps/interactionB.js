...
::-webkit-scrollbar {
  ...
  <div class='d-flex flex-row align-items-center p-2 bg-dark bg-opacity-25'>
    ...
    <div class='interaction flex-fill'>
      <!-- B -->
      <tdd-excustomaccordion id='bb' class='' color='blue'>
        <div slot='content'>
            <div class="wc">
  ...
  <div class='d-flex flex-row align-items-center p-2 bg-dark bg-opacity-50'>
    ...
    <div class='interaction flex-fill'>
      <!-- C -->
      <tdd-excustomaccordion id='cc' class='' color='blue'>
        <div slot='content'>
            <div class="wc">
  ...
  <div class='d-flex flex-row align-items-center p-2 bg-dark bg-opacity-75 text-light'>
    ...
    <div class='d-flex flex-row flex-fill justify-content-between gap-2'>
    
      <div class='interaction w-50'>
        <!-- D -->
        <tdd-excustomaccordion id='dd' class='' color='blue'>
          <div slot='content'>
              <div class="wc">
      ...
      <div class='interaction w-50'>
        <!-- E -->
        <tdd-excustomaccordion id='ee' class='' color='blue'>
          <div slot='content'>
              <div class="wc">
      ...
      <div class='interaction w-50'>
        <!-- F -->
        <tdd-excustomaccordion id='ff' class='' color='blue'>
          <div slot='content'>
              <div class="wc">
      ...
      <div class='interaction w-50'>
        <!-- G -->
        <tdd-excustomaccordion id='gg' class='' color='blue'>
          <div slot='content'>
              <div class="wc">
  ...
  <div class='d-flex flex-row align-items-center p-2 bg-dark text-light'>
    ...
    <div class='d-flex flex-column flex-fill justify-content-between gap-2'>
      <div class='interaction flex-fill'>
        <!-- H -->
        <tdd-excustomaccordion id='hh' class='' color='blue'>
          <div slot='content'>
              <div class="wc">
      ...
      <div class='interaction flex-fill'>
        <!-- I -->
        <tdd-excustomaccordion id='ii' class='' color='blue'>
          <div slot='content'>
              <div class="wc">
...
class interactionB extends HTMLElement {
  constructor() {
    super();
...
customElements.define('tdd-interaction-b', interactionB);